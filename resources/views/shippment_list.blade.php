                ...
                <div class="table-container">
                    <table class="table">
                        <thead class="table__thead">
                            <tr>
                                <th class="table__th ">Upload Data </th>
                            ...
                            @foreach ($shipments as $shipment)
                                ...
                                @endphp <tr class="table-row table-row--chris">
                                    <td data-column="upload_date" class="table-row__td">
                                        <div class="table-row__info">
                                            <p class="table-row__name">
                                                {{ date('M j, Y', strtotime($shipment->shipment_upload_date)) }}</p>
                                        </div>
                                    </td>
                                    ...
                                    <td data-column="order_details" class="table-row__td">
                                        <div class="table-row__info">
                                            <button onclick="details(this)" type="button"
                                                class="{{ $shipment->shipment_id }} btn btn-primary"
                                                id="{{ $shipment->shipment_id }}">Details</button>
                                        </div>
                                    </td>
                                    ...
                                    <td data-column="print" class="table-row__td">
                                        <div class="table-row__info">
                                            ...
                                            <button type="button" class="btn btn-primary"><a class="print"
                                                    href="{{ '/public/uploads/barcodes/' . $shipment->barcode_image_name }}"
                                                    download>Print</a></button>
                                        </div>
                                    </td>
                                    <td data-column="track" class="table-row__td">
                                        <div class="table-row__info">
                                            <button type="button" class="btn btn-primary"><a target="blank"
                                                    class="print"
                                                    href="track/shipment?kspNumber={{ $shipment->ksp_number }}">Track</a></button>
                                        </div>
                                    </td>
                                    <td data-column="delete" class="table-row__td">
                                        <div class="table-row__info">
                                            <button type="button" onclick="delete_shipment(this)"
                                                id="delete_{{ $shipment->shipment_id }}" class="btn btn-primary">
                                                <i class="delete fas fa-trash-alt" style="font-weight: 500;"></i>
                                            </button>
                                        </div>
                                    </td>
                                    </tr>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response['status'] == 'success') {
                                ...
                                var ele = document.getElementById("loader" + shipment_id).parentElement;
                                $(ele).html(
                                    '<button type="button" onclick="delete_shipment(this)"id="delete_' +
                                    shipment_id +
                                    '" class="btn btn-primary"><i class="fas fa-trash-alt" style="font-weight: 500;"></i></button>'
                                )
