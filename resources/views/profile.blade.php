    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 card card-body">
            <div class="right"
                ...
                <img style="width: 70%;padding: 1rem 0rem 1rem 0rem;" src="{{ asset('data-checked.png') }}"
                    alt="data_reviewing">
                    <div style="display: flex;align-items: flex-end;justify-content: end;" class="row">
                        <h3 > Your Account is active now </h3>
                        <img style="width: 77px;padding: 0rem 0rem 0.3rem 0rem;" src="{{ asset('verified.png') }}">
                    </div>
            </div>
            <div class="left" style="margin: -10px 0px -10px 0px;">
                <h3 style="margin-bottom: 1rem;margin-left: 2rem;width: 110%;margin-top: 1.5rem;color: #d5b06c;text-align: center;font-weight: bold;font-size: 26px;letter-spacing: 2px;">
                    Your Information
                </h3>
