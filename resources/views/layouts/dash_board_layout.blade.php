...
<head>
    ...
    <script>
        if (($('#sub1').hasClass('active') || $('#sub2').hasClass('active')) && sub_action == 1) {

            $('#creating_order').addClass("sub_space");
            sub_action = 2;
            console.log("opened sub");
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                @if (Auth::user()->type == 1)
                    ...
                    <li class="@if (Route::current()->getName() == 'create' || Route::current()->getName() == 'upload') active @endif nav-item menu-items" id="creating_order"
                        onclick="@if (Route::current()->getName() == 'create' || Route::current()->getName() == 'upload') sub_subOrder(this)  @else subOrder(this) @endif ">
                        <a class="@if (Route::current()->getName() == 'create' || Route::current()->getName() == 'upload') active selected @endif nav-link" id="sub"
                            data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
                            <span class="menu-icon">
                                <i class="fab fa-wpforms" id="child1"></i>
                            </span>
                            <span class="menu-title">Creating Order</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse @if (Route::current()->getName() == 'create' || Route::current()->getName() == 'upload') show @endif " id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="@if (Route::current()->getName() == 'create') active @endif nav-item" id="sub1"
                                    onclick="opened(this)">
                                    <a style="padding-left: 15px;"
                                        class="@if (Route::current()->getName() == 'create') active selected @endif nav-link"
                                        href="new_order"> Order by order</a>
                                </li>
                                <li class="@if (Route::current()->getName() == 'upload') active @endif nav-item" id="sub2"
                                    onclick="opened(this)"> <a style="padding-left: 15px;"
                                        class="@if (Route::current()->getName() == 'upload') active selected @endif nav-link"
                                        href="upload_orders">List of orders</a></li>

                            </ul>
                        </div>
                    </li>
                    {{-- <li class="@if (Route::current()->getName() == 'create') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'create') active selected @endif nav-link" href="new_order">
                            <span class="menu-icon">
                                <i class="fab fa-wpforms" id="child1"></i>
                            </span>
                            <span class="menu-title">Creating Order</span>
                    ...
                    <li class="@if (Route::current()->getName() == 'shipments') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'shipments') selected @endif nav-link" href="shippment_list">
                            <span class="menu-icon">
                                <i class="fas fa-list-ul" id="child2"></i>
                            </span>
                            <span class="menu-title">Shipments' List</span>
                        </a>
                    </li>
                    <li class="nav-item menu-items" id="parent">
                        <a class="nav-link" href="">
                            <span class="menu-icon">
                                <i class="fas fa-exclamation" id="child3"></i>
                            </span>
                ...
                @else
                    ...
                    <li class="@if (Route::current()->getName() == 'vendors') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'vendors') selected @endif nav-link"
                            href="vendors_shipments">
                            <span class="menu-icon">
                                <i class="fas fa-boxes" style="color: #fcfcfc;" id="child6"></i>
                            </span>
                            <span class="menu-title">Vendors shipments</span>
                        </a>
                    </li>
                    <li class="@if (Route::current()->getName() == 'scan_barcodes') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'scan_barcodes') active selected @endif nav-link"
                            href="scanBarcodes">
                            <span class="menu-icon">
                                <i class="fab fa-wpforms" id="child1"></i>
                            </span>
                            <span class="menu-title">Scan Barcodes</span>
                        </a>
                    </li>
                    <li class="@if (Route::current()->getName() == 'pending_shipments') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'pending_shipments') selected @endif nav-link"
                            href="pending_shipments">
                            <span class="menu-icon">
                                <i class="fas fa-hourglass-start" id="child2"></i>
                            </span>
                            <span class="menu-title">Pending shipments</span>
                        </a>
                    </li>
                    <li class="@if (Route::current()->getName() == 'create_awb' || Route::current()->getName() == 'create_bulk_awb') active @endif nav-item menu-items"
                        id="creating_order"
                        onclick="@if (Route::current()->getName() == 'create_awb' || Route::current()->getName() == 'create_bulk_awb') sub_subOrder(this)  @else subOrder(this) @endif ">

                        <a class="@if (Route::current()->getName() == 'create_awb' || Route::current()->getName() == 'create_bulk_awb') active selected @endif nav-link" id="sub"
                            data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
                            <span class="menu-icon">
                                <i class="fab fa-wpforms" id="child1"></i>
                            </span>
                            <span class="menu-title">Create AWB</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse @if (Route::current()->getName() == 'create_awb' || Route::current()->getName() == 'create_bulk_awb') show @endif " id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="@if (Route::current()->getName() == 'create_awb') active @endif nav-item" id="sub1">
                                    <a onclick="opened(this)" style="padding-left: 15px;"
                                        class="@if (Route::current()->getName() == 'create_awb') active selected @endif nav-link"
                                        href="client_shipment_awb"> Shipment by shipment</a>
                                </li>
                                <li class="@if (Route::current()->getName() == 'create_bulk_awb') active @endif nav-item" id="sub2">
                                    <a onclick="opened(this)" style="padding-left: 15px;"
                                        class="@if (Route::current()->getName() == 'create_bulk_awb') active selected @endif nav-link"
                                        href="client_bulk_shipment_awb?page=1">List of Shipments</a></li>

                            </ul>
                        </div>
                    </li>
                    {{-- <li class="@if (Route::current()->getName() == 'create_awb') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'create_awb') selected @endif nav-link"
                            href="client_shipment_awb">
                            <span class="menu-icon">
                                <i class="fas fa-plus" id="child3"></i>
                            </span>
                            <span class="menu-title">Create AWB</span>
                        </a>
                    </li> --}}
                    <li class="@if (Route::current()->getName() == 'warehouse') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'warehouse') selected @endif nav-link"
                            href="shipments_managment">
                            <span class="menu-icon">
                                <i class="fas fa-list-ul" style="color: #17a2b8;" id="child5"></i>
                            </span>
                            <span class="menu-title">Shipments' List</span>
                        </a>
                    </li>
                    <li class="@if (Route::current()->getName() == 'accounts') active @endif nav-item menu-items" id="parent">
                        <a class="@if (Route::current()->getName() == 'accounts') selected @endif nav-link"
                            href="accounts_managment">
                            <span class="menu-icon">
                                <i class="fas fa-user" style="color: #a458f7;" id="child7"></i>
                            </span>
        ...
        <div class="container-fluid page-body-wrapper ">
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul style="display: flex;justify-content: flex-end;padding: 0rem 2.3rem 0rem 0rem;"
                        class="navbar-nav navbar-nav-right w-100">
                        <li style="width: 65%;" class="nav-item">
                            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                                <div class="col column">
                                    <div style="display: flex;align-items: center;" class="input-icons">
                                        <i style="color: #2c6242;margin-left: 15px;" class="fas fa-search"></i>
                                        <input type="text" id="myInput" onkeyup="search_shipment(this)"
                                            placeholder="Search for shipment *( Min:4 character)"
                                            title="Type a order number" autocomplete="off">
                                    </div>

                                    <div id="results" class="result col"
                                        style="padding-bottom: 10px;padding-top: 10px;border-radius: 6px;border: 1px solid #ffffff4f;box-shadow: 0 3px 3px -2px rgb(0 0 0 / 20%), 0 3px 4px 0 rgb(0 0 0 / 14%), 0 1px 8px 0 rgb(0 0 0 / 12%);display:none;margin-left: 0.2rem;margin-right: 1rem;margin-top: 1px;width: 90%;max-height: 250px;overflow: hidden scroll;z-index: 10;position: absolute;background-color: rgb(27, 52, 37);padding-bottom: 15px;">

                                    </div>
                                </div>

                                <input type="text" id="user" value="{{ Auth::user()->id }}" readonly
                                    hidden>
                                <input type="text" id="user_type" value="{{ Auth::user()->type }}" readonly
                                    hidden>
                            </form>
                        </li>

                        <li class="nav-item dropdown show">
                            <a class="nav-link  dropdown-toggle" id="profileDropdown dropdownMenuLink" href="#"
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                    ...
                                    <a class="dropdown-item preview-item" href="profile"
                                        ...
                                        <div class="preview-item-content">
                                            <p class="preview-subject mb-1">Edit Information </p>
                                        </div>

                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item preview-item" style="border-radius: 0px 0px 6px 6px ;"
                                        href="{{ route('logout') }}"
                            ...
                            @else
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                    aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item preview-item" style="border-radius: 6px 6px 6px 6px ;"
                                        href="{{ route('logout') }}"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
<script>
    function subOrder(element) {
        if (!($('#sub1').hasClass('active') || $('#sub2').hasClass('active'))) {
            if (side_action == 1) {
                $('#creating_order').addClass("sub_order");

                console.log('opened');
                side_action = 2;
            } else if (side_action == 2) {

                setTimeout(function() {
                    $("#creating_order").removeClass("sub_order");
                }, 400);
    ...
    function sub_subOrder(element1) {
        console.log(sub_action);

        if (sub_action == 2) {
            setTimeout(function() {
                $("#creating_order").removeClass("sub_space");
            }, 400);
            sub_action = 1;
            /*
