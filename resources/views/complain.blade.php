...
<style>
    ...
    .btn.btn-primary {
        ...
        border: 0;
        border-radius: 3rem;
        background-image: linear-gradient(131deg, #060c37, #111e65, #009d9c, #11abba);
...
<body>
    <div id="app">
        {{-- <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a href="/"><img style="width: 15%;" src="{{ url('kshopina.jpeg') }}" alt=""></a>
      ...
      -------------------------------------------------------------
      ------------------------------------------------------------>
            <form action="send_message" enctype="multipart/form-data" method="post" id="form">
                {{ csrf_field() }}
                <div class="title text-center mb-4">
                    <img style="width: 190px;" src="{{ asset('kshopina_mail.png') }}">

                </div>
                @if (count($errors) > 0)
                    <div class="alert alert-danger">
                        Send Message Validation<br><br>
                        <ul>
                ...
                <div class="form-group position-relative">
                    <label for="formName" class="d-block">
                        <i class="icon far fa-user" data-feather="user"></i>
                    </label>
                    <input type="text" id="formName" name="name" class="form-control thick" placeholder="Name" required
                        maxlength="20">
                </div>
                ...
                <div class="form-group position-relative">
                    <label for="formName" class="d-block">
                        <i class="icon fas fa-hashtag" data-feather="user"></i>
                    </label>
                    <input type="number" name="order_number" id="formOrder" class="form-control thick"
                ...
                <div class="form-group position-relative">
                    <label for="formName" class="d-block">
                        <i class="icon fas fa-map-marker-alt" data-feather="user"></i>
                    </label>
                    <select name="country" id="formOrder" class="form-control thick" placeholder="Country">
                ...
                <!-- E-mail -->
                <small style="/* margin-left: 0px; */color: #dc0000;font-size: 70%;">*Make sure the email address is valid to be able to follow up*</small>
                <div class="form-group position-relative">
                    <label for="formEmail" class="d-block">
                        <i class="icon far fa-envelope" data-feather="mail"></i>
                    </label>
                    <input type="email" name="email" id="formEmail" class="form-control thick" placeholder="E-mail"
                        required maxlength="90">
                </div>
                <!-- whatsapp -->
                <div class="form-group position-relative">
                    <label for="formName" class="d-block">
                        <i class="icon fab fa-whatsapp" data-feather="user"></i>
                    </label>
                    <input type="number" name="whatsapp" id="formwhatsapp" class="form-control thick"
                ...
                <div style="display: grid; margin:5px;">
                    <div style="display: flex;">
                        <div style="font-size: 1.25rem;margin-right: 25px;" class="form-group position-relative">

                            <input onclick="count(this)" type="CHECKBOX" name="Missing_items" id="Missing"
                                class="thick" placeholder="Name">
                            Missing items.
                        </div>
                        <div style="font-size: 1.25rem;" class="form-group position-relative">

                            <input onclick="count(this)" type="CHECKBOX" name="Wrong_items" id="Wrong"
                                class="thick" placeholder="Name">
                            Wrong items.

                        </div>
                    </div>
                    <div style="font-size: 1.25rem;margin-right: 10px;" class="form-group position-relative">

                        <input onclick="count(this)" type="CHECKBOX" name="No_response" id="No_response"
                            class="thick" placeholder="Name">
                        No response from courier company
                    </div>
                    <div style="display: flex;">
                        <div style="font-size: 1.25rem;margin-right: 25px;" class="form-group position-relative">

                            <input onclick="count(this)" type="CHECKBOX" name="Late_Delivery" id="Late"
                                class="thick" placeholder="Name">
                            Late Delivery.
                        ...
                        <div style="font-size: 1.25rem;margin-right: 25px;" class="form-group position-relative">
                            ...
                            <input onclick="count(this)" type="CHECKBOX" name="cancel_order" id="cancel_order"
                                class="thick" placeholder="Name">
                            Cancel order.
                        ...
                        <div style="font-size: 1.25rem;" class="form-group position-relative">
                            ...
                            <input onclick="count(this)" type="CHECKBOX" name="Others" id="Others"
                                class="thick" placeholder="Name">
                            Others
                        </div>
                    </div>
                ...
                <div class="form-group message">
                    <textarea style="height: 120px;" name="Others_message" id="formMessage" class="form-control" rows="7"
                        placeholder="Write the other problem here..." maxlength="99"></textarea>
                </div>

                <!-- Submit btn -->
                <div class="text-center">
                    <button id="submit_btn" class="btn btn-primary " tabIndex="-1">Send
                        message</button>
                </div>
    ...
    <script type="text/javascript">
       ...
       /*  if (document.getElementById('Others').checked) {
        ...
        function count(elemant) {
            if (elemant.checked == false) {
                counter = counter - 1;
            } else if (counter == 2) {
        ...
        $('#form').submit(function() {
            ...
            $('#submit_btn').text('');
            $('#submit_btn').addClass('buttonload');
            $('#submit_btn').append('<i class="fa fa-spinner fa-spin"></i>Loading');
